...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content">
        ...
        <div class="experience" id="legalpracticesummary">
            <div class="content-inner">
                <div class="content-header">
                    <h2>Legal Practice Summary</h2>
                </div>
                <p>With more than 5 years of experience, specializes in various legal domains:</p>
                <div class="row align-items-top">
                    <div class="col-md-6">
                        <div class="exp-col">
                            <span style="font-size: 20px"><b>Intellectual Property (Trademark)</b></span>
                            <ul>
                                <li>Conducted trademark searches and classified goods/services under the Nice Classification.</li>
                                <li>Filed trademark applications and handled oppositions and cancellation proceedings.</li>
                                <li>Issued Cease and Desist notices and managed trademark renewals and maintenance.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="exp-col">
                            <span style="font-size: 20px"><b>Insolvency & Bankruptcy</b></span>
                            <br />
                            <ul>
                                <li>Managed IBC matters and represented clients before the National Company Law Tribunal (NCLT).</li>
                                <li>Drafted petitions, demand notices, and defense arguments for creditors.</li>
                                <li>Attended CIRP and CoC meetings, drafting minutes and conducting legal research.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="exp-col">
                            <span style="font-size: 20px"><b>Civil & Commercial Litigation</b></span>
                            <ul>
                                <li>Drafted pleadings, written statements, and counterclaims for civil matters.</li>
                                <li>Handled breach of contract cases and real estate injunction petitions.</li>
                                <li>Managed cases under Section 138 of the Negotiable Instruments Act.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="exp-col">
                            <span style="font-size: 20px"><b>Corporate Law & Compliance</b></span>
                            <ul>
                                <li>Assisted in company incorporations and handled registrations and filings.</li>
                                <li>Managed annual compliances and MCA-related compliance matters.</li>
                                <li>Drafted and reviewed corporate filings and handled legal strategies.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="exp-col">
                            <span style="font-size: 20px"><b>Commercial Drafting</b></span>
                            <ul>
                                <li>Drafted contracts such as NDAs, Service Agreements, and MOUs.</li>
                                <li>Reviewed Shareholder and Joint Venture Agreements.</li>
                                <li>Negotiated and drafted Supply and Purchase Agreements.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="exp-col">
                            <span style="font-size: 20px"><b>Family Law</b></span>
                            <ul>
                                <li>Managed mutual consent divorce proceedings and advised clients on legal strategies.</li>
                                <li>Drafted settlement agreements and mediated discussions between parties.</li>
                                <li>Ensured compliance with legal formalities and court orders.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form">
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <asp:TextBox ID="txtYourEmail" runat="server" CssClass="form-control" placeholder="Your Email"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtMessage" runat="server" CssClass="form-control" placeholder="Message" TextMode="MultiLine" Rows="5" MaxLength="1000"></asp:TextBox>
                                </div>
                                <div>
